...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Pre-Exam Result'])
    
    <div class="container-fluid py-4">
        <p class="fw-bolder">Learning Strands</p>
        <div class="exam-result row text-center overflow-hidden"></div>
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                ...
                                <a href="javascript:;" id="print-result" class="text-sm text-danger"><i class="fas fa-print me-1 text-sm"></i> Print Result</a>
                            </div>
...
<script data-navigate-once>
    ...
    document.addEventListener('livewire:navigated', () => {
        ...
        const container = document.querySelector(".exam-result");
        const courses = [
