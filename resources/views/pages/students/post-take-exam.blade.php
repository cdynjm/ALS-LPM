...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Post Test'])
            ...
            <div class="col-md-10 mt-2">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="text-center m-4 fw-bolder">POST-TEST | FUNCTIONAL LITERACY TEST (FLT)</h4>
                    ...
                    <div class="card-body pt-4 p-3">
                        <form action="" id="submit-post-exam">
                            <ul class="list-group">
