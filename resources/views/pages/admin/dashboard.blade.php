                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                <div class="icon icon-shape bg-gradient-warning shadow-primary text-center rounded-circle">
                                    <i class="fas fa-users opacity-10 text-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Learning Strands</p>
                                    <h5 class="font-weight-bolder fs-3">
                                        @livewire('fetch-learning-count')
                                    </h5>
                                    <p class="mb-0 text-xs">
                                        Total Count
                                    </p>
                            ...
                            <div class="col-4 text-end">
                                <div class="icon icon-shape bg-gradient-success shadow-primary text-center rounded-circle">
                                    <i class="fa-solid fa-graduation-cap text-lg opacity-10"></i>
                                </div>
                            </div>
                        </div>
                    </div>
